...
function AgeStats({ database, setShowStatsAges, setFilterDataFromStats, role }) {
    ...
    useEffect(() => {
        const handleEsc = (event) => { if (event.keyCode === 27) setShowStatsAges(""); };
